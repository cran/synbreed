 ...
 * </p>
 * When the {@code FileIterator} instance is no longer needed,
 * the {@code close()} method should be invoked to free up
 * system resources.  After calling {@code close()}, invoking
 * {@code hasNext()} returns {@code false}, and invoking
 ...
 */
public interface FileIterator<E> extends java.util.Iterator<E>, Closeable {

    /**
     * Returns the file from which data are read, or returns
     * {@code null} if the file source is unknown or is standard input.
    ...
    /**
     * Closes the file iterator.  After invoking {@code close}, further
